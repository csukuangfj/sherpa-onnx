// sherpa-onnx/csrc/tts-text-normalizer.cc
//
...
#if __ANDROID_API__ >= 9
template std::vector<std::unique_ptr<kaldifst::TextNormalizer>>
LoadTextNormalizers(AAssetManager *mgr, const std::string &rule_fsts,
                   const std::string &rule_fars, bool debug);
#endif

#if __OHOS__
template std::vector<std::unique_ptr<kaldifst::TextNormalizer>>
LoadTextNormalizers(NativeResourceManager *mgr, const std::string &rule_fsts,
                   const std::string &rule_fars, bool debug);
#endif
