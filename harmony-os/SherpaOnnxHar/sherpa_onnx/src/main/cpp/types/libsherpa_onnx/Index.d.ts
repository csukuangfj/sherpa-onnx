export const listRawfileDir: (dir: string) => Array<string>;
...
export const createVoiceActivityDetector: (config: object, bufferSizeInSeconds?: number) => object;
...
export const createOfflineRecognizer: (config: object) => object;
...
export const createOnlineRecognizer: (config: object) => object;
...
export const createOfflineTts: (config: object) => object;
...
export const createSpeakerEmbeddingExtractor: (config: object) => object;
...
export const createOfflineSpeakerDiarization: (config: object) => object;
...
export const createKeywordSpotter: (config: object) => object;
