    ...
    def run_decoder(
        ...
        logits = self.decoder.run(
            ...
            ],
            {
                ...
                self.decoder.get_inputs()[1].name: n_layer_cross_k.numpy(),
                self.decoder.get_inputs()[2].name: n_layer_cross_v.numpy(),
            },
        )[0]
...
def main():
    ...
    print(model.sot_sequence)  # [sot, notimstamps]
    tokens = model.sot_sequence + model.sot_sequence * 5
