...
SA8797 soc_id    72 dsp_arch     v81 vtcm_size (MB)     16
...
SM8845 soc_id    97 dsp_arch     v81 vtcm_size (MB)      8
SM7675 soc_id   643 dsp_arch     v73 vtcm_size (MB)      2
SM7635 soc_id   640 dsp_arch     v73 vtcm_size (MB)      2
...
QCM6490 soc_id   93 dsp_arch     v68 vtcm_size (MB)      2
...
soc_info_list = [
    ...
    SocInfo(Chipset.SA8797, HtpInfo(HtpArch.v81, 16)),
    ...
    SocInfo(Chipset.SM8845, HtpInfo(HtpArch.v81, 8)),
    SocInfo(Chipset.SM7675, HtpInfo(HtpArch.v73, 2)),
    SocInfo(Chipset.SM7635, HtpInfo(HtpArch.v73, 2)),
    ...
    SocInfo(Chipset.QCM6490, HtpInfo(HtpArch.v68, 2)),
